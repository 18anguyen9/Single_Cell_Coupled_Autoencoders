...
def get_train_coupled(df1, df2):
    ...
    for epoch in range(200):
        ...
        for i in range(0,num_points, batch_size_coupled):
            ...
            #get predictions
            code_output_gex,outputs_gex_adt, outputs_gex_gex = model_coupled(cur_batch_gex, to_adt=False)
            code_output_adt,outputs_adt_adt, outputs_adt_gex = model_coupled(cur_batch_adt, to_adt=True)
